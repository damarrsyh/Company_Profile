...
<body>
  ...
  <section class="page-section">
    <div class="container my-5" id="services">
      <h4 class="text-center mb-2">List Branch</h4>
          ...
          <tbody>
            ...
            @foreach($branches as $index => $branch)
              <tr>
                <td>{{ $index + 1 }}</td>
                <td>{{ $branch->name }}</td>
                <td>@thousand($branch->total_member)</td>
                <td class="text-start">Rp. @thousand($branch->total_equity)</td>
                <td><a href="/branch/{{ $branch->id }}" class="btn btn-sm btn-info">Detail</a></td>
              </tr>
            @endforeach
          </tbody>
        </table>
