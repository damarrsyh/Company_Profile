  ...
  <section class="page-section">
    <div class="container my-5" id="services">
      ...
      <div class="row justify-content-center">
        <div class="col-md-10 align-self-center" style="border-radius: 15px; background: var(--bs-gray-100);">
          <div class="card mx-5 my-5">
            <div class="card-header">
              <div class="d-flex justify-content-between">
                ...
                <a href="/branch/index" class="btn btn-sm btn-secondary">Back</a>
            ...
            <div class="card-body">
              ...
              <div class="mb-5">
                ...
                <table class="table table-bordered text-center">
                  ...
                  <tbody>
                    @foreach ($branch->outstanding as $index => $outstanding)
                      <tr>
                        <td>{{ $index + 1 }}</td>
                        <td>{{ $outstanding->description }}</td>
                        <td class="text-start">Rp. @thousand($outstanding->main)</td>
                        <td class="text-start">Rp. @thousand($outstanding->margin)</td>
                        <td>@thousand($outstanding->member)</td>
                      </tr>
                    @endforeach
                  </tbody>
                </table>
              ...
              <div class="mb-5">
                ...
                <table class="table table-bordered text-center">
                  ...
                  <tbody>
                    @foreach ($branch->repayment as $index => $repayment)
                      <tr>
                        <td>{{ $index + 1 }}</td>
                        <td>{{ $repayment->description }}</td>
                        <td class="text-start">Rp. @thousand($repayment->main)</td>
                        <td class="text-start">Rp. @thousand($repayment->margin)</td>
                        <td>@thousand($repayment->member)</td>
                      </tr>
                    @endforeach
                  </tbody>
                </table>
              ...
              <div class="mb-5">
                ...
                <table class="table table-bordered text-center">
                  ...
                  <tbody>
                    @foreach ($branch->par as $index => $par)
                      <tr>
                        <td>{{ $index + 1 }}</td>
                        <td>{{ $par->description }}</td>
                        <td class="text-start">Rp. @thousand($par->outstanding)</td>
                        <td>@thousand($par->member)</td>
                        <td>{{ $par->par }}%</td>
                      </tr>
                    @endforeach
                  </tbody>
